...
file = open("C:/Litvin Sofia/CW24/aps_cw/aps_cw/factories.txt")
file1 = open("C:/Litvin Sofia/CW24/aps_cw/aps_cw/devices.txt")
cnt = 0
cnt1 = 0
...
class UserTable(QMainWindow):
    ...
    def initUI(self):
        self.setWindowTitle(f"Factories table")
...
if __name__ == "__main__":
    ...
    for line in file1:
        cnt1 += 1
        data = line.split()
        res1[int(data[1][0:-1])] = float(data[2])
